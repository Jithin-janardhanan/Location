...
//       'receiverId': receiverId, // Must not be empty
//       'timestamp': timestamp,
//     };
//   }
...
//     try {
//       // Get vendor email safely
//       final vendorEmail = widget.vendorData['email'] as String? ?? '';
//       // final vendorId = widget.vendorData[''] as String? ?? '';
...
//         currentUserEmail ?? '',
//         vendorEmail
//       ]..sort(); // Sort to ensure consistent room ID
...
//         'participants': [currentUserId, widget.vendorData['vendorId']],
//         'participantDetails': {
//           currentUserId: {
...
//   //     // Create chat room ID using user ID and vendor ID
//   //     final List<String> roomParticipants = [currentUserId ?? '', vendorId]
//   //       ..sort(); // Sort to ensure consistent room ID
//   //     final String chatRoomId = roomParticipants.join('_');
...
//   //       'senderId': currentUserId,
//   //       'senderName': currentUserName,
//   //       'receiverId': vendorId, // Using vendorId instead of email
//   //       'message': _messageController.text.trim(),
//   //       'timestamp': FieldValue.serverTimestamp(),
//   //     });
